...
Button btnCamera;
    ...
    //Prueba Camara
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Lo implementaremos más tarde...", Snackbar.LENGTH_LONG)
       ...
       Fragment fragment = null;
        ...
        if (id == R.id.nav_camera) {
           ...
           FragmentTransaction = true;
            ...
            //Cambiamos el titulo de arriba
            getSupportActionBar().setTitle("Nav Share");

        } else if (id == R.id.nav_send) {
            Log.i("NavigationDrawer", "Entro en opción send");
            //Cambiamos el titulo de arriba
            getSupportActionBar().setTitle("Nav Send");

        }else if ( id == R.id.map) {
            Toast.makeText(getApplicationContext(), "Entrando en maps...", Toast.LENGTH_LONG).show();
    ...
    //Lo añadimos para poder comunicarnos con nuestros Fragments
    @Override
